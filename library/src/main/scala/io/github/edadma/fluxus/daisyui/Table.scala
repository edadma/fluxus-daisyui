...
val Pagination = (props: PaginationProps) => {
  ...
  val showEllipsisStart =
    props.showPageNumbers && pageNumbers.contains(1) && !pageNumbers.contains(2) && props.totalPages > 1
  val showEllipsisEnd = props.showPageNumbers && pageNumbers.contains(props.totalPages) && !pageNumbers.contains(
    props.totalPages - 1,
  ) && props.totalPages > 1
